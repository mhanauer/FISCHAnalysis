...
dat_FISCH = dat_FISCH[c("record_id","colevel_1", "colevel_2", "colevel_3", "colevel_4", "colevel_5", "colevel_6","session0date", "session1date", "session2date", "session3date", "session4date", "session5date", "session6date", "gender","ethnicity", "education")]
